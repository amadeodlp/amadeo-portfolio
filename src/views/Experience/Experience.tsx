  ...
  const experiences: WorkExperience[] = [
    {
      ...
      role: "Cloud Architecture & AI Integration Specialist",
      period: "August 2023 - Present",
      description:
        "Specializing in AWS cloud architecture and AI integration for enterprise systems. Leading cloud infrastructure design with measurable business impact, including 30% cost reduction and 35% improvement in workflow efficiency through innovative AI solutions.",
      ...
      responsibilities: [
        "Architected enterprise-grade AWS cloud infrastructure reducing operational costs by 30% while improving scalability and security",
        "Designed and implemented Model-Context-Protocol servers to integrate Claude AI with Github and Jira, reducing manual workflows by 35%",
        "Led strategic migration from Auth0 to AWS Cognito, optimizing authentication while enhancing security posture",
        "Engineered high-performance cross-platform interchange service using AWS services (DynamoDB, Lambda) with Java and Spring Boot",
        "Created reusable component libraries and design systems that accelerated development across multiple enterprise applications",
      ],
    },
    {
      id: "firstclose",
