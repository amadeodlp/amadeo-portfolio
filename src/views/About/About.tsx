      ...
      <HeroSection
        ...
        description={
          <div className="mt-4 bg-black/70 backdrop-blur-sm p-4 rounded-lg">
            ...
            I'm a full-stack dev with 3+ years of experience in SaaS development, but in reality... I’m more of a problem-solver, tech enthusiast, and project wizard. Right now, I'm at Viking Sasquatch, working with React, TypeScript, Java, Spring Boot, .NET, and AWS services. I’m bilingual, super creative, and have a knack for making the connection between engineering and business needs, all while keeping things fun and efficient. Let’s just say, if it involves code, I’m probably already on it!
            </p>
          </div>
        }
      />
        ...
        <div className="container mx-auto px-4">
          <div className="mb-16">
            <InfoSection>
              ...
              private repositories on Github, Gitlab and Azure. With over 3 years of experience in SaaS development, 
              I'm skilled in bridging the gap between engineering and business needs through effective communication and 
              creativity. My expertise spans across various technologies including React, Next.js, Spring Boot, .NET, and AWS.
            </InfoSection>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-white/80">
                <p>
                  As a passionate Software Developer, I specialize in building modern web applications
                  with a focus on clean code, performance, and user experience. My journey in
                  software development started over 5 years ago, and I've been continuously learning
                  and improving my skills ever since.
                </p>
                <p>
                  I enjoy working with technologies like React, TypeScript, Node.js, and exploring
                  new tools and frameworks. When I'm not coding, I like to read about technology trends,
                  contribute to open-source projects, and share my knowledge with the community.
                </p>
                <p>
                  I believe in the power of collaboration and continuous learning. My goal is to create
                  software that not only solves problems but also provides a delightful experience for users.
                </p>
              </div>
            </div>
            ...
            <div className="bg-dark-light p-6 rounded-lg shadow-lg">
              <div className="flex items-center mb-6">
                ...
                <div className="ml-4">
                  <h3 className="text-xl font-bold text-white">Amadeo de la Peña</h3>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {educationItems.map((item, index) => (
              ...
              >
                <div className="text-[#653490] font-bold mb-2">{item.period}</div>
      ...
      <section className="bg-gradient-to-r from-[#653490] to-[#00E9C5] py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/90 mb-8 max-w-2xl mx-auto">
            I'd love to be part of your next project or join your team.
